...
public class MorseCodeConverterTest_STUDENT_Test {
    File inputFile;
    ...
    public void testConvertToEnglishString() {
        ...
        assertEquals("hi my name is eric deng hi",converter1);

        String test2="morse code testing";
        String converter2 = MorseCodeConverter.convertToEnglish("-- --- .-. ... . / -.-. --- -.. . / - . ... - .. -. --. ");
        assertEquals("morse code testing", converter2);
    }
