...
public class NotationQueueTest {
    ...
    public double z=3,y=4,x=5,w=6,v=7,u=8;
    @Before
    ...
    public void testDequeueStudent() {
        ...
        try {
            assertEquals(new Double(z), doubleQ.dequeue());
            assertEquals(new Double(y), doubleQ.dequeue());
            assertEquals(new Double(x), doubleQ.dequeue());
            //Queue is empty, next statement should cause QueueUnderFlowException
            doubleQ.dequeue();
            assertTrue("This should have caused an QueueUnderflowException", false);
        }
    ...
    public void testEnqueueStudent() {
        ...
        try {
            ...
            assertEquals(true, doubleQ.enqueue(w));
            assertEquals(4, doubleQ.size());
            assertEquals(true, doubleQ.enqueue(v));
    ...
    public void testToStringStudent() throws QueueOverflowException{
        //Use the doubleQ for student tests
        assertEquals("3.04.05.0", doubleQ.toString());
        doubleQ.enqueue(w);
        assertEquals("3.04.05.06.0", doubleQ.toString());
        doubleQ.enqueue(v);
        assertEquals("3.04.05.06.07.0", doubleQ.toString());
    }
